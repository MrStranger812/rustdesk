...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [HamrahDesk Input] service."),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant HamrahDesk \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant HamrahDesk \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running HamrahDesk."),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use HamrahDesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade HamrahDesk Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent HamrahDesk from running properly as controlled side."),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if HamrahDesk window is open"),
        ...
        ("floating_window_tip", "It helps to keep HamrahDesk background service"),
        ...
        ("About RustDesk", "About HamrahDesk"),
